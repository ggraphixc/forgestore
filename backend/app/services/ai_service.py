...
SETTINGS_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    # ── Design & Branding ──
    {"key": "site_name", "category": "design", "type": "text", "label": "Site Name",
     "description": "Brand name displayed in header, footer, and page titles.", "default": "ForgeStore"},
    {"key": "site_tagline", "category": "design", "type": "text", "label": "Site Tagline",
     "description": "Short tagline or slogan displayed below the site name.", "default": "Where the Workshop Meets the World"},
    {"key": "primary_color", "category": "design", "type": "text", "label": "Primary Color (Hex)",
     "description": "Primary brand color used for buttons, links, and accents.", "default": "#f59e0b"},
    ...
    {"key": "logo_url", "category": "design", "type": "text", "label": "Logo URL",
     "description": "URL or path to the site logo image.", "default": ""},
    {"key": "favicon_url", "category": "design", "type": "text", "label": "Favicon URL",
     "description": "URL or path to the favicon (.ico, .png, or .svg).", "default": ""},
    ...
    {"key": "contact_phone", "category": "design", "type": "text", "label": "Contact Phone",
     "description": "Public contact phone number.", "default": ""},
