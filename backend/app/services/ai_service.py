...
SETTINGS_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    {"key": "site_initials", "category": "global", "type": "file", "label": "Site Initials / Logo Mark",
     "description": "Upload a 2-letter abstract mark or logo. Used in sidebar, header, and auth pages.", "default": "FS"},
    {"key": "stat_shops", "category": "global", "type": "text", "label": "Artisan Shops Stat",
     "description": "Stat shown on auth pages (e.g. '500+').", "default": "500+"},
    {"key": "stat_items", "category": "global", "type": "text", "label": "Unique Items Stat",
     "description": "Stat shown on auth pages (e.g. '10K+').", "default": "10K+"},
    {"key": "stat_buyers", "category": "global", "type": "text", "label": "Happy Buyers Stat",
     "description": "Stat shown on auth pages (e.g. '50K+').", "default": "50K+"},
    ...
    {"key": "business_hours", "category": "global", "type": "select", "label": "Business Hours",
     "description": "Operating hours shown on the storefront.",
     "default": "Mon-Fri 9am-6pm",
     "options": [{"value": "Mon-Fri 9am-6pm", "label": "Mon-Fri 9am-6pm"},
                 {"value": "Mon-Sat 9am-6pm", "label": "Mon-Sat 9am-6pm"},
                 {"value": "Mon-Fri 8am-5pm", "label": "Mon-Fri 8am-5pm"},
                 {"value": "Mon-Sat 8am-8pm", "label": "Mon-Sat 8am-8pm"},
    ...
    {"key": "refine_theme", "category": "design", "type": "select", "label": "Refine Theme",
     "description": "Visual style preset applied on top of your color choices. Controls border radius, shadows, spacing, and overall feel.",
     "default": "balanced",
     "options": [{"value": "minimal", "label": "Minimal — Clean lines, no shadows, flat feel"},
                 {"value": "balanced", "label": "Balanced — Moderate radius, soft shadows (default)"},
                 {"value": "rounded", "label": "Rounded — Extra rounded corners, deeper shadows"},
                 {"value": "sharp", "label": "Sharp — Square corners, tight spacing, bold look"},
                 {"value": "glass", "label": "Glass — Frosted glass effect with backdrop blur"},
                 {"value": "brutalist", "label": "Brutalist — Raw, high-contrast, industrial feel"}]},
    ...
    # ── Technical ──
    {"key": "inventory_threshold", "category": "technical", "type": "select", "label": "Low Stock Threshold",
     "description": "Inventory count at which low-stock alerts are triggered.",
     "default": "5",
     "options": [{"value": "3", "label": "3 items"}, {"value": "5", "label": "5 items"},
                 {"value": "10", "label": "10 items"}, {"value": "15", "label": "15 items"},
                 {"value": "20", "label": "20 items"}, {"value": "50", "label": "50 items"}]},
    {"key": "max_upload_size_mb", "category": "technical", "type": "select", "label": "Max Upload Size (MB)",
     "description": "Maximum file size for product images.",
     "default": "10",
     "options": [{"value": "2", "label": "2 MB"}, {"value": "5", "label": "5 MB"},
                 {"value": "10", "label": "10 MB"}, {"value": "20", "label": "20 MB"},
                 {"value": "50", "label": "50 MB"}]},
    {"key": "image_quality", "category": "technical", "type": "select", "label": "Image Quality %",
     "description": "JPEG quality for compressed product images.",
     "default": "85",
     "options": [{"value": "50", "label": "50% (smallest file)"}, {"value": "60", "label": "60%"},
                 {"value": "70", "label": "70%"}, {"value": "80", "label": "80%"},
                 {"value": "85", "label": "85% (balanced)"}, {"value": "90", "label": "90%"},
                 {"value": "95", "label": "95% (highest quality)"}]},
    {"key": "session_timeout_minutes", "category": "technical", "type": "select", "label": "Session Timeout (minutes)",
     ...
     "options": [{"value": "15", "label": "15 minutes"}, {"value": "30", "label": "30 minutes"},
                 ...
                 {"value": "480", "label": "8 hours"}, {"value": "1440", "label": "24 hours (1 day)"},
                 {"value": "10080", "label": "7 days"}, {"value": "0", "label": "Never (no timeout)"}]},
    ...
    {"key": "max_discount_percent", "category": "optional", "type": "select", "label": "Max Discount %",
     ...
     "options": [{"value": "20", "label": "20%"}, {"value": "30", "label": "30%"},
                 ...
                 {"value": "90", "label": "90%"}, {"value": "100", "label": "100% (no limit)"}]},
    ...
    {"key": "opencode_zen_model", "category": "developer", "type": "select", "label": "OpenCode Zen Model",
     "description": "Free models available.",
     "default": "mimo-v2.5-free",
     "options": [{"value": "mimo-v2.5-free", "label": "MiMo v2.5 Free (recommended)"},
    ...
    {"key": "openai_model", "category": "developer", "type": "select", "label": "OpenAI Model",
     "description": "Select the OpenAI model to use.",
     "default": "gpt-4o-mini",
     "options": [{"value": "gpt-4o-mini", "label": "GPT-4o Mini (fast, cheap)"},
    ...
    # ── Design & Branding ──
    {"key": "secondary_color", "category": "design", "type": "color", "label": "Secondary Color",
     "description": "Secondary brand color used for hover states and accents.", "default": "#d97706"},
    {"key": "dark_color", "category": "design", "type": "color", "label": "Dark/Background Color",
     "description": "Dark background color for headers and footers.", "default": "#1c1917"},
    {"key": "text_color", "category": "design", "type": "color", "label": "Text Color",
    ...
    {"key": "currency_symbol", "category": "design", "type": "select", "label": "Currency Symbol",
     "description": "Currency symbol used throughout the site.",
     "default": "₦",
     "options": [{"value": "₦", "label": "₦ (Naira)"},
                 {"value": "$", "label": "$ (Dollar)"},
                 {"value": "€", "label": "€ (Euro)"},
                 {"value": "£", "label": "£ (Pound)"},
                 {"value": "KSh", "label": "KSh (Kenyan Shilling)"},
                 {"value": "GH₵", "label": "GH₵ (Cedi)"},
    ...
    {"key": "return_window_days", "category": "logistics", "type": "select", "label": "Return Window (days)",
     "description": "Number of days customers have to return items.",
     "default": "14",
     "options": [{"value": "3", "label": "3 days"}, {"value": "7", "label": "7 days"},
                 {"value": "14", "label": "14 days"}, {"value": "21", "label": "21 days"},
                 {"value": "30", "label": "30 days"}]},
    {"key": "max_order_items", "category": "logistics", "type": "select", "label": "Max Items Per Order",
     "description": "Maximum quantity of items allowed in a single order.",
     "default": "50",
     "options": [{"value": "5", "label": "5 items"}, {"value": "10", "label": "10 items"},
                 {"value": "20", "label": "20 items"}, {"value": "50", "label": "50 items"},
                 {"value": "100", "label": "100 items"}, {"value": "999", "label": "No limit"}]},
    ...
    # ── Low-Stock Alerts ──
    {"key": "low_stock_limit", "category": "logistics", "type": "select", "label": "Low Stock Alert Threshold",
     "description": "Inventory level at which vendors receive low-stock warnings.",
     "default": "5",
     "options": [{"value": "3", "label": "3 items"}, {"value": "5", "label": "5 items"},
                 {"value": "10", "label": "10 items"}, {"value": "15", "label": "15 items"},
    ...
    # ── Notifications ──
    {"key": "whatsapp_graph_api_version", "category": "developer", "type": "select", "label": "WhatsApp Graph API Version",
     "description": "Meta Graph API version for WhatsApp messages.",
     "default": "v17.0",
     "options": [{"value": "v17.0", "label": "v17.0"}, {"value": "v18.0", "label": "v18.0"},
                 {"value": "v19.0", "label": "v19.0"}, {"value": "v20.0", "label": "v20.0 (latest)"}]},
    {"key": "brevo_sender_name", "category": "developer", "type": "text", "label": "Brevo Sender Name",
     "description": "Display name for outgoing email sender.", "default": ""},

    # ── AI Embedding ──
    {"key": "ai_embedding_model", "category": "developer", "type": "select", "label": "AI Embedding Model",
     "description": "Model used for text embeddings (recommendations, search).",
     "default": "text-embedding-3-small",
     "options": [{"value": "text-embedding-3-small", "label": "text-embedding-3-small (recommended)"},
    ...
    {"key": "minimum_payout_amount", "category": "financial", "type": "select", "label": "Minimum Payout Amount",
     "description": "Minimum amount vendors can request for payout.",
     "default": "5000",
     "options": [{"value": "1000", "label": "₦1,000"}, {"value": "2500", "label": "₦2,500"},
    ...
    {"key": "payout_hold_days", "category": "financial", "type": "select", "label": "Payout Hold Days",
     "description": "Days to hold funds after delivery before releasing to vendor.",
     "default": "7",
     "options": [{"value": "1", "label": "1 day"}, {"value": "3", "label": "3 days"},
                 {"value": "5", "label": "5 days"}, {"value": "7", "label": "7 days"},
    ...
    {"key": "payment_retry_attempts", "category": "financial", "type": "select", "label": "Max Retry Attempts",
     "description": "Maximum number of payment retry attempts.",
     "default": "3",
     "options": [{"value": "1", "label": "1 attempt"}, {"value": "2", "label": "2 attempts"},
                 {"value": "3", "label": "3 attempts"}, {"value": "5", "label": "5 attempts"}]},
    {"key": "payment_retry_interval_hours", "category": "financial", "type": "select", "label": "Retry Interval (Hours)",
     "description": "Hours between payment retry attempts.",
     "default": "24",
    ...
    {"key": "tax_name", "category": "financial", "type": "select", "label": "Tax Display Name",
     "description": "Name displayed for tax on invoices.",
     "default": "VAT",
     "options": [{"value": "VAT", "label": "VAT"}, {"value": "GST", "label": "GST"},
                 {"value": "Sales Tax", "label": "Sales Tax"}, {"value": "Service Tax", "label": "Service Tax"},
    ...
    {"key": "refund_window_days", "category": "financial", "type": "select", "label": "Refund Window (Days)",
     "description": "Days after delivery within which customers can request a refund.",
     "default": "7",
     "options": [{"value": "3", "label": "3 days"}, {"value": "7", "label": "7 days"},
                 {"value": "14", "label": "14 days"}, {"value": "30", "label": "30 days"},
    ...
    {"key": "max_order_amount", "category": "financial", "type": "select", "label": "Maximum Order Amount",
     "description": "Maximum single order amount (0 = no limit).",
     "default": "0",
     "options": [{"value": "0", "label": "No limit"}, {"value": "100000", "label": "₦100,000"},
                 {"value": "500000", "label": "₦500,000"}, {"value": "1000000", "label": "₦1,000,000"},
    ...
    {"key": "payment_timeout_minutes", "category": "financial", "type": "select", "label": "Payment Timeout (Minutes)",
     "description": "Minutes to hold an order before unpaid cart expires.",
     "default": "30",
     "options": [{"value": "15", "label": "15 minutes"}, {"value": "30", "label": "30 minutes"},
                 {"value": "45", "label": "45 minutes"}, {"value": "60", "label": "1 hour"},
                 {"value": "120", "label": "2 hours"}, {"value": "1440", "label": "24 hours"}]},
    ...
    {"key": "password_min_length", "category": "technical", "type": "select", "label": "Minimum Password Length",
     "description": "Minimum character length for user passwords.",
     "default": "8",
     "options": [{"value": "6", "label": "6 characters"}, {"value": "8", "label": "8 characters"},
                 {"value": "10", "label": "10 characters"}, {"value": "12", "label": "12 characters"},
                 {"value": "14", "label": "14 characters"}, {"value": "16", "label": "16 characters"}]},
    ...
    {"key": "max_login_attempts", "category": "technical", "type": "select", "label": "Max Login Attempts",
     "description": "Failed login attempts before lockout. 0 = disabled.",
     "default": "5",
     "options": [{"value": "3", "label": "3 attempts"}, {"value": "5", "label": "5 attempts"},
                 {"value": "10", "label": "10 attempts"}, {"value": "15", "label": "15 attempts"},
                 {"value": "0", "label": "Disabled"}]},
    {"key": "lockout_duration_minutes", "category": "technical", "type": "select", "label": "Lockout Duration (Minutes)",
     "description": "Minutes to lock account after max failed logins.",
     "default": "15",
     "options": [{"value": "5", "label": "5 minutes"}, {"value": "10", "label": "10 minutes"},
    ...
    {"key": "email_button_color", "category": "design", "type": "color", "label": "Email Button Color",
     "description": "Color for call-to-action buttons in emails.", "default": "#f59e0b"},

    # ── Product Catalog ──
    {"key": "max_product_images", "category": "optional", "type": "select", "label": "Max Product Images",
     "description": "Maximum number of images per product.",
     "default": "10",
     "options": [{"value": "5", "label": "5 images"}, {"value": "10", "label": "10 images"},
                 {"value": "15", "label": "15 images"}, {"value": "20", "label": "20 images"}]},
    {"key": "max_image_size_mb", "category": "optional", "type": "select", "label": "Max Image Size (MB)",
     "description": "Maximum file size for uploaded images.",
     "default": "10",
     "options": [{"value": "2", "label": "2 MB"}, {"value": "5", "label": "5 MB"},
                 {"value": "10", "label": "10 MB"}, {"value": "20", "label": "20 MB"}]},
    {"key": "reviews_min_length", "category": "optional", "type": "select", "label": "Min Review Length",
     "description": "Minimum character count for review text (0 = no minimum).",
     "default": "10",
     "options": [{"value": "0", "label": "No minimum"}, {"value": "10", "label": "10 characters"},
                 {"value": "20", "label": "20 characters"}, {"value": "50", "label": "50 characters"}]},
    {"key": "reviews_max_length", "category": "optional", "type": "select", "label": "Max Review Length",
     "description": "Maximum character count for review text (0 = no limit).",
     "default": "2000",
     "options": [{"value": "0", "label": "No limit"}, {"value": "500", "label": "500 characters"},
                 {"value": "1000", "label": "1,000 characters"}, {"value": "2000", "label": "2,000 characters"},
                 {"value": "5000", "label": "5,000 characters"}]},
    {"key": "product_name_max_length", "category": "optional", "type": "select", "label": "Max Product Name Length",
     "description": "Maximum character count for product names.",
     "default": "200",
     "options": [{"value": "50", "label": "50 characters"}, {"value": "100", "label": "100 characters"},
                 {"value": "150", "label": "150 characters"}, {"value": "200", "label": "200 characters"}]},
    {"key": "product_description_max_length", "category": "optional", "type": "select", "label": "Max Description Length",
     "description": "Maximum character count for product descriptions.",
     "default": "5000",
     "options": [{"value": "1000", "label": "1,000 characters"}, {"value": "2000", "label": "2,000 characters"},
                 {"value": "5000", "label": "5,000 characters"}, {"value": "10000", "label": "10,000 characters"}]},
    {"key": "max_product_variants", "category": "optional", "type": "select", "label": "Max Product Variants",
     "description": "Maximum number of variants (size/color combos) per product.",
     "default": "20",
     "options": [{"value": "5", "label": "5 variants"}, {"value": "10", "label": "10 variants"},
                 {"value": "20", "label": "20 variants"}, {"value": "50", "label": "50 variants"}]},
    ...
    {"key": "currency_decimal_places", "category": "global", "type": "select", "label": "Currency Decimal Places",
     "description": "Number of decimal places for currency display.",
     "default": "2",
     "options": [{"value": "0", "label": "0 (₦1,500)"},
                 {"value": "2", "label": "2 (₦1,500.00)"},
                 {"value": "3", "label": "3 (₦1,500.000)"}]},
    {"key": "currency_thousand_separator", "category": "global", "type": "select", "label": "Thousand Separator",
     "description": "Character used as thousand separator.",
     "default": ",",
     "options": [{"value": ",", "label": ", (comma) → 1,500"},
                 {"value": ".", "label": ". (dot) → 1.500"},
                 {"value": " ", "label": "space → 1 500"},
                 {"value": "'", "label": "' (apostrophe) → 1'500"}]},
    {"key": "currency_decimal_separator", "category": "global", "type": "select", "label": "Decimal Separator",
     "description": "Character used as decimal separator.",
     "default": ".",
     "options": [{"value": ".", "label": ". (dot) → 1500.00"},
                 {"value": ",", "label": ", (comma) → 1500,00"}]},
]
